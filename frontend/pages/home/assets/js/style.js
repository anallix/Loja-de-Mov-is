...
const eventDate = new Date('March 30 2024 23:59:00')/**inserir a data do final do evento */
...
setTimeout( () =>{
  ...
  setInterval(updateCountdown, 1000); // Adicionando um intervalo para atualizar o contador a cada segundo
}, 1000)
